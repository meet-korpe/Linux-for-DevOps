...
* **Directory Management**:  
  **Create a directory:** mkdir dir\_name   
  **Remove an empty directory:** rmdir dir\_name   
...
* **Recursive Copy (-r):** cp \-r source\_dir destination\_dir (copies a directory and all its contents)   
